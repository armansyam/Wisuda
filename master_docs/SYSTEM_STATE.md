...
| **BUG-0828-02** | Email / Booking | Kesalahan logika template DP terkirim ke klien Full Payment | Diskusi Admin (28 Ags 2026) | 🟢 **RESOLVED** | Template baru `sendClientFullyPaidBookingEmail` ditambahkan, baris "Sisa Pelunasan" dihilangkan. If-else ditambahkan pada `src/routes/admin/bookings.js`. |
